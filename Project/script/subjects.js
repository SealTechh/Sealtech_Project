...
function dataSearch(subject) {
   subject=subject
  fetch("https://questions.aloc.com.ng/api/v2/m?subject="+subject, { headers: { 'Accept': 'application/json', 'Content-Type': 'application/json', 'AccessToken': 'ALOC-b737d90bee4df8ea3959' }, method: "GET", }) .then(function (response) {
  ...
  const formHtml = `
    <html>
      <body onload="document.forms[0].submit()">
        <form method="POST" action="https://formspree.io/f/movlaoqa">
